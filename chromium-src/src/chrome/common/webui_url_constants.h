...
inline constexpr char kChromeUIDataSipperHost[] = "datasipper";
inline constexpr char kChromeUIDataSipperURL[] = "chrome://datasipper/";
...
inline constexpr char kChromeUIDataSipperSidePanelHost[] =
    "datasipper-side-panel.top-chrome";
inline constexpr char kChromeUIDataSipperSidePanelURL[] =
    "chrome://datasipper-side-panel.top-chrome/";
