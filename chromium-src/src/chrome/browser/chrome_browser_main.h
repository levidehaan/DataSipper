...
// DataSipperNetworkClient is in the global namespace
...
class ChromeBrowserMainParts : public content::BrowserMainParts {
 ...
 private:
  ...
  // DataSipper service for network monitoring and data capture
  std::unique_ptr<datasipper::DataSipperService> datasipper_service_;
  std::unique_ptr<DataSipperNetworkClient> datasipper_network_client_;
};
