...
class BrowserWindowFeatures {
 public:
  ...
  DataSipperSidePanelCoordinator* datasipper_side_panel_coordinator() {
    return datasipper_side_panel_coordinator_.get();
  }
 ...
 private:
  ...
  std::unique_ptr<DataSipperSidePanelCoordinator>
      datasipper_side_panel_coordinator_;
