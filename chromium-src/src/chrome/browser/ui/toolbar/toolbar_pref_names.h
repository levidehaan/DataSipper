...
// Indicates whether DataSipper has been migrated to the new toolbar container.
inline constexpr char kDataSipperMigrationComplete[] =
    "toolbar.datasipper_migration_complete";
