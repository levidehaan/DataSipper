...
void NetworkService::SetDataSipperClient(
    mojo::PendingRemote<datasipper::mojom::DataSipperNetworkClient> client) {
  DataSipperMojoClientHolder::GetInstance()->SetClient(std::move(client));
  LOG(INFO) << "✅ NetworkService: DataSipper client set successfully";
}
